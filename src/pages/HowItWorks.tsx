      ...
      <div className="bg-teal-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-teal-100">Simple, fast, and efficient delivery process</p>
          </div>
        </div>
      </div>
          ...
          {steps.map(({ icon: Icon, title, description }, index) => (
            <div key={title} className="material-card p-6 rounded-xl text-center">
              <div className="flex justify-center">
                <div className="p-3 rounded-full bg-teal-400/10 w-fit">
                  <Icon className="h-6 w-6 text-teal-400" />
                </div>
              </div>
              <div className="mt-4 text-xl font-medium text-teal-600">
